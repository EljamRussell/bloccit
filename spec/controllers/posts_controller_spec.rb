...
RSpec.describe PostsController, type: :controller do
  ...
  context "guest user" do
    #the show tests, which allow guests to view posts in Bloccit.
    ...
    # define tests for the other CRUD actions. We won't allow guests to access the  create, new, edit, update, or destroy actions.
    describe "GET new" do
  ...
  # wrap our existing specs in a context so that they become our signed-in user specs.
